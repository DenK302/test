#############################################################################
# Makefile for building: MyQtApp.app/Contents/MacOS/MyQtApp
# Generated by qmake (3.1) (Qt 6.7.2)
# Project:  MyQtApp.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile MyQtApp.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = MyQtApp1.0.0
DISTDIR = /Users/denk/Documents/Mod\ Organizer\ Reborn/test/.tmp/MyQtApp1.0.0
...
SOURCES       = main.cpp \
		forms/mainWindow.cpp moc_mainWindow.cpp
OBJECTS       = main.o \
		mainWindow.o \
		moc_mainWindow.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		MyQtApp.pro forms/mainWindow.h main.cpp \
		forms/mainWindow.cpp
QMAKE_TARGET  = MyQtApp
DESTDIR       = 
TARGET        = MyQtApp.app/Contents/MacOS/MyQtApp

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.4
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/denk/Documents/Mod Organizer Reborn/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/denk/Documents/Mod Organizer Reborn/test/MyQtApp.pro
...
MyQtApp.app/Contents/MacOS/MyQtApp:  $(OBJECTS)  
	@test -d MyQtApp.app/Contents/MacOS/ || mkdir -p MyQtApp.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: MyQtApp.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.2/share/qt/mkspecs/common/macx.conf \
...
MyQtApp.app/Contents/PkgInfo: 
	@test -d MyQtApp.app/Contents || mkdir -p MyQtApp.app/Contents
	@$(DEL_FILE) MyQtApp.app/Contents/PkgInfo
	@echo "APPL????" > MyQtApp.app/Contents/PkgInfo
MyQtApp.app/Contents/Info.plist: 
	@test -d MyQtApp.app/Contents || mkdir -p MyQtApp.app/Contents
	@$(DEL_FILE) MyQtApp.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.MyQtApp,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.MyQtApp,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,MyQtApp,g" -e "s,@LIBRARY@,MyQtApp,g" -e "s,\$${EXECUTABLE_NAME},MyQtApp,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >MyQtApp.app/Contents/Info.plist

all: Makefile \
		MyQtApp.app/Contents/PkgInfo \
		MyQtApp.app/Contents/Info.plist MyQtApp.app/Contents/MacOS/MyQtApp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents forms/mainWindow.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp forms/mainWindow.cpp $(DISTDIR)/
...
moc_mainWindow.cpp: forms/mainWindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/denk/Documents/Mod Organizer Reborn/test/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/denk/Documents/Mod Organizer Reborn/test' -I'/Users/denk/Documents/Mod Organizer Reborn/test/forms' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib forms/mainWindow.h -o moc_mainWindow.cpp
